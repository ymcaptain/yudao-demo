...
public class PayClientFactoryImpl implements PayClientFactory {
    ...
    private <Config extends PayClientConfig> AbstractPayClient<Config> createPayClient(
        ...
        switch (channelEnum) {
            case WX_JSAPI: return (AbstractPayClient<Config>) new WXJsapiPayClient(channelId, (WXPayClientConfig) config);
            case WX_H5: return (AbstractPayClient<Config>) new WXH5PayClient(channelId, (WXPayClientConfig) config); //H5页面支付请求
