package cn.iocoder.yudao.module.bpm.cmd;

import cn.iocoder.yudao.module.bpm.framework.flowable.constant.BpmConstant;
...
public class AddSequenceMultiInstanceCmd implements Command<Void> {
    ...
    public Void execute(CommandContext commandContext) {
        ...
        Integer nrOfInstances = (Integer)entity.getVariable(BpmConstant.NUMBER_OF_INSTANCES);
        entity.setVariable(BpmConstant.NUMBER_OF_INSTANCES, nrOfInstances + assignees.size());
        // 设置流程变量
